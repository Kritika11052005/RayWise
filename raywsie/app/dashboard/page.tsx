...
const Dashboard = () => {
    ...
    const handleComparePlans = async () => {
        if (savedProjects.length === 0 && finalizedLayouts.length === 0) {
            toast.warning('Please create at least one project first!');
            return;
        }
        ...
        try {
            ...
            if (data.success) {
                ...
                toast.error('Failed to compare plans: ' + data.error);
            }
        } catch (error) {
            console.error('Error comparing plans:', error);
            toast.error('Failed to fetch plan comparisons');
        } finally {
    ...
    const handleFindInstallers = async () => {
        ...
        if (!userLocation) {
            toast.warning('Please create a project first to determine your location!');
            return;
        }
        ...
        try {
            ...
            if (data.success) {
                ...
                toast.error('Failed to find installers: ' + data.error);
            }
        } catch (error) {
